...
import { createRouter, createMemoryHistory, useRoute, useRouter, RouterLink, createWebHistory } from "vue-router";
...
const routes = [
  { path: "/", name: "home", component: () => import("./assets/index.page-Dg0OFpR9.js") },
  { path: "/product/:id", name: "product", component: () => import("./assets/index.page-CcCguvp2.js"), props: true },
