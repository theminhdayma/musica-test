...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<form${ssrRenderAttrs(mergeProps({ class: "search" }, _attrs))} data-v-64026154><svg class="ic" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" data-v-64026154><circle cx="11" cy="11" r="7" data-v-64026154></circle><path d="m20 20-3.5-3.5" data-v-64026154></path></svg><input${ssrRenderAttr("value", value.value)} type="search" placeholder="Tìm tác phẩm, nghệ sĩ…" data-v-64026154></form>`);
    };
  }
});
...
const HeaderSearch = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-64026154"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-8b9837ab><div class="container header-inner" data-v-8b9837ab>`);
      ...
      _push(`<nav class="nav-main" aria-label="Primary" data-v-8b9837ab>`);
      _push(ssrRenderComponent(unref(RouterLink), {
        to: "/",
        class: "nav-link"
      }, {
      ...
      _push(`<a href="#categories" class="nav-link" data-v-8b9837ab>Thể loại</a><a href="#artists" class="nav-link" data-v-8b9837ab>Nghệ sĩ</a><a href="#how" class="nav-link" data-v-8b9837ab>Quy trình</a><a href="#pricing" class="nav-link" data-v-8b9837ab>Bảng giá</a></nav><div class="nav-actions" data-v-8b9837ab>`);
      ...
      _push(ssrRenderComponent(unref(RouterLink), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-8b9837ab${_scopeId}><path d="M3 3h2l2.4 12.4a2 2 0 0 0 2 1.6h8.7a2 2 0 0 0 2-1.5L22 7H6" data-v-8b9837ab${_scopeId}></path><circle cx="9" cy="20" r="1.4" data-v-8b9837ab${_scopeId}></circle><circle cx="18" cy="20" r="1.4" data-v-8b9837ab${_scopeId}></circle></svg>`);
            if (count.value) {
              _push2(`<span class="badge" data-v-8b9837ab${_scopeId}>${ssrInterpolate(count.value)}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      if (isAuthed.value) {
        _push(`<button class="btn btn-ghost btn-sm" type="button" data-v-8b9837ab>Đăng xuất</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="btn btn-primary btn-sm" data-v-8b9837ab>Đăng bán tác quyền</button></div></div></header>`);
    };
  }
};
...
const AppHeader = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-8b9837ab"]]);
const _sfc_main$1 = {
  __name: "AppFooter",
  __ssrInlineRender: true,
  setup(__props) {
...
const routes = [
  { path: "/", name: "home", component: () => import("./assets/index.page-71TjO9dc.js") },
  {
    path: "/market",
    name: "market",
    redirect: (to) => {
  ...
  { path: "/search/:q?/:tab?", name: "search", component: () => import("./assets/index.page-0TPoxpYD.js"), props: true },
  { path: "/product/:id", name: "product", component: () => import("./assets/index.page-KtNRbmb4.js"), props: true },
