...
import { defineComponent, ref, onMounted, createSSRApp, useSSRContext, mergeProps, unref, computed, onUnmounted, withCtx, createVNode, createTextVNode, openBlock, createBlock, toDisplayString, createCommentVNode, resolveComponent, resolveDynamicComponent, Transition } from "vue";
import { createRouter, createMemoryHistory, useRoute, useRouter, RouterLink } from "vue-router";
...
const BrandLogo = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-3b91b688"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-6e8f7cee><div class="container header-inner" data-v-6e8f7cee>`);
      ...
      _push(`<nav class="nav-main" aria-label="Primary" data-v-6e8f7cee>`);
      _push(ssrRenderComponent(unref(RouterLink), {
        to: "/",
        class: "nav-link"
      }, {
      ...
      _push(`<a href="#categories" class="nav-link" data-v-6e8f7cee>Thể loại</a><a href="#artists" class="nav-link" data-v-6e8f7cee>Nghệ sĩ</a><a href="#how" class="nav-link" data-v-6e8f7cee>Quy trình</a><a href="#pricing" class="nav-link" data-v-6e8f7cee>Bảng giá</a></nav><div class="nav-actions" data-v-6e8f7cee><button class="icon-btn" aria-label="Tìm kiếm" data-v-6e8f7cee><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-6e8f7cee><circle cx="11" cy="11" r="7" data-v-6e8f7cee></circle><path d="m20 20-3.5-3.5" data-v-6e8f7cee></path></svg></button>`);
      _push(ssrRenderComponent(unref(RouterLink), {
        to: "/cart",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-6e8f7cee${_scopeId}><path d="M3 3h2l2.4 12.4a2 2 0 0 0 2 1.6h8.7a2 2 0 0 0 2-1.5L22 7H6" data-v-6e8f7cee${_scopeId}></path><circle cx="9" cy="20" r="1.4" data-v-6e8f7cee${_scopeId}></circle><circle cx="18" cy="20" r="1.4" data-v-6e8f7cee${_scopeId}></circle></svg>`);
            if (count.value) {
              _push2(`<span class="badge" data-v-6e8f7cee${_scopeId}>${ssrInterpolate(count.value)}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      if (isAuthed.value) {
        _push(`<button class="btn btn-ghost btn-sm" type="button" data-v-6e8f7cee>Đăng xuất</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="btn btn-primary btn-sm" data-v-6e8f7cee>Đăng bán tác quyền</button></div></div></header>`);
    };
  }
};
...
const AppHeader = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-6e8f7cee"]]);
const _sfc_main$1 = {
  __name: "AppFooter",
  __ssrInlineRender: true,
  setup(__props) {
...
const routes = [
  { path: "/", name: "home", component: () => import("./assets/index.page-CA-SXMw0.js") },
  { path: "/market", name: "market", component: () => import("./assets/index.page-CAkgaVRw.js") },
  { path: "/product/:id", name: "product", component: () => import("./assets/index.page-CaMnjcLE.js"), props: true },
  { path: "/cart", name: "cart", component: () => import("./assets/index.page-BY_gc8E8.js") },
  { path: "/checkout", name: "checkout", component: () => import("./assets/index.page-CICFZL0w.js") },
  ...
  { path: "/me/certificates", name: "my-certificates", component: () => import("./assets/list.page-DHDTkuhj.js"), meta: { requiresAuth: true, requiredRoles: ["BUYER"] } },
  { path: "/me/certificates/:certificateId", name: "certificate-detail", component: () => import("./assets/detail.page-CaGjLCao.js"), props: true, meta: { requiresAuth: true, requiredRoles: ["BUYER"] } },
  { path: "/me/products", name: "my-products", component: () => import("./assets/list.page-CimyUdSK.js"), meta: { requiresAuth: true, requiredRoles: ["ARTIST"] } },
  { path: "/me/products/:productId", name: "my-product-detail", component: () => import("./assets/detail.page-ClZ_THpm.js"), props: true, meta: { requiresAuth: true, requiredRoles: ["ARTIST"] } }
];
